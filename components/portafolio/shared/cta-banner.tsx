...
export function CTABanner({ title, subtitle, ctaText, ctaHref }: CTABannerProps) {
  return (
    <section className="relative py-20 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="text-center space-y-8 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl">
          ...
          <div className="flex flex-col items-center gap-4 pt-4">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-[#2dd4bf] to-[#14b8a6] text-black hover:opacity-90 font-semibold rounded-full px-12 py-7 text-lg shadow-lg shadow-[#2dd4bf]/30 hover:shadow-xl hover:shadow-[#2dd4bf]/40 transition-all hover:scale-105"
            >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 h-[500px] w-[500px] rounded-full bg-[#2dd4bf]/10 blur-[120px]" />
      <div className="absolute top-0 right-0 -z-10 h-[400px] w-[400px] rounded-full bg-purple-500/10 blur-[120px]" />
    </section>
  );
}
